...
# mlk-100mhz
# set_property -dict {PACKAGE_PIN AD12 IOSTANDARD SSTL135} [get_ports i_clk]
# set_property -dict {PACKAGE_PIN D26 IOSTANDARD LVCMOS33} [get_ports i_Rst_n]

#
# ov5640-1

set_property -dict {PACKAGE_PIN F9 IOSTANDARD LVCMOS33} [get_ports io_cmos_scl1]
...
# mlk
# set_property -dict {PACKAGE_PIN J21 IOSTANDARD LVCMOS33} [get_ports {o_led[2]}]
...
# set_property -dict {PACKAGE_PIN AA26 IOSTANDARD LVCMOS33} [get_ports system_uart_debug_rxd]
# set_property -dict {PACKAGE_PIN Y26 IOSTANDARD LVCMOS33} [get_ports system_uart_debug_txd]
#------------------- Ethernet MII PHY1 ----------------------
